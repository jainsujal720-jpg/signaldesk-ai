...
analysis_path = (
    ROOT / "src/analysis/semantic_clustering.py"
)

test_path = (
    ROOT / "tests/test_semantic_clustering.py"
)

analysis_path.write_text(
    CLUSTERING_CODE.strip() + "\n",
    encoding="utf-8",
)
...
print("Created: src/analysis/semantic_clustering.py")
print("Created: tests/test_semantic_clustering.py")
print("Phase 5 embeddings and clustering layer created.")